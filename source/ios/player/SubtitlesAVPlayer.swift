...
public extension AVPlayer {
    ...
    // MARK: - Public methods
    func addSubtitles(labelSubtitle: UILabel) -> Self {
        
        // Create label
        addSubtitleLabel(labelSubtitle: labelSubtitle)
    ...
    func open(file filePath: URL, encoding: String.Encoding = String.Encoding.utf8) {
        do {
            ...
            print("error while loading subtitles file")
        }
    }
    ...
    fileprivate func addSubtitleLabel(labelSubtitle: UILabel) {
        
        guard let _ = subtitleLabel else {
            
            // Label
            //subtitleLabel = UILabel()
            subtitleLabel = labelSubtitle
            subtitleLabel?.translatesAutoresizingMaskIntoConstraints = false
            subtitleLabel?.backgroundColor = UIColor.black.withAlphaComponent(0.5) //UIColor(hexString: "#000000", alpha: 0.5)
